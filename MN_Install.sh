#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='BAALCOIN.conf'
CONFIGFOLDER='/root/.BAALCOIN'
COIN_DAEMON='baalcoind'
COIN_CLI='BAALCOIN-cli'
COIN_PATH='/usr/local/bin/'
COIN_GETDMN='https://github.com/baalcoin/BAALCOIN/releases/download/1.0.0.0/baalcoind'
COIN_GETCLI='https://github.com/baalcoin/BAALCOIN/releases/download/1.0.0.0/baalcoin-cli'
COIN_NAME='BAALCOIN'
COIN_EXPLORER='http://149.28.248.66'
COIN_PORT=60033
RPC_PORT=60034
...
#ADDNODES
addnode=149.28.248.66
addnode=207.148.2.24
addnode=144.202.72.247
addnode=144.202.71.32
EOF
}
